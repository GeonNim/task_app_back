...
# loader = DirectoryLoader("./data", glob="*.txt", loader_cls=SafeTextLoader)  # 커스텀 로더 지정 # 경로, 타입, 사용 함수
...
# answer = rag_chain.stream("청년를 위한 정책을 알려주세요")
stream_response(recieved_question)
